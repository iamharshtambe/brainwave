...
export default function ComponentItem({ itemName }) {
  return (
    <div className="relative mb-6 flex w-full transform cursor-pointer items-center justify-between rounded-full bg-white p-6 text-xl font-semibold transition duration-300 hover:scale-102">
